...
--
-- Servidor: localhost
-- Tiempo de generación: 20-04-2016 a las 07:06:40
...
INSERT INTO `cohortes` (`id`, `cohorte`) VALUES
(1, '2016-I');
...
INSERT INTO `curso` (`idcurso`, `especialidad`, `nombre`, `descripcion`, `uc`) VALUES
(3, 'EPEI001', 'Cliente', 'Estudios didacticos', 6),
(5, 'EPEI001', 'Algebra Lineal', 'Calculo I', 5),
(6, 'EPEI001', 'Aplicación de Procesos Cognitivos en el Aula', 'Aunar la cognición del niño y niña dentro de ', 2),
(7, 'EPEI001', 'Investigación en Ambientes de Aprendizajes', 'Teorizacion de los procesos formativos en edu', 2),
(8, 'EPEI001', 'Gestión de Proyectos', 'Analizar los programas operativos para una ge', 2),
(9, 'EPEI001', 'Desarrollo Integral de 0 a 3 Años', 'La integridad de los procesos formativos de l', 3),
(10, 'EPEI001', 'Desarrollo Integral de 3 a 6 Años', 'Procesos formativos de niños y niñas de 3 a 6', 3),
(11, 'EPEI001', 'Educación Inicial e Integración Comunitaria', 'La Comunidad como eje interventor en los proc', 3),
(12, 'EPEI001', 'Génesis de la Inteligencia Psicomotora', 'Los inicios de los procesos formativos de la ', 3),
(13, 'EPEI001', 'Atención a la Diversidad e Integración en Edu', 'La cosmovisión de la Educación Inicial ', 3),
(14, 'EPEI001', 'La Inteligencia Emocional en ls Infantes de 0', 'Descubrir las emociones y sentimientos de los', 3),
(15, 'EPEI001', 'Practium I', 'Análisis metodológica de proyecto de investig', 3),
(16, 'EPEI001', 'Practicum II', 'Metodología aplicada a la educación', 3),
(17, 'EPDEB01', 'Aplicación de Procesos Cognitivos en el Aula', 'Teoria del Aprendizaje en los ambientes de ap', 2),
(18, 'EPDEB01', 'Investigación en Ambientes de Aprendizajes', 'Fomentar las Teorías de Aprendizaje en los pr', 3),
(19, 'EPDEB01', 'Gestión de Proyecto', 'Analizar los diversos niveles de gestión basa', 2),
(20, 'EPDEB01', 'Teorías y Enfoques para la Práctica Pedagógic', 'Conceptualizar los Paradígmas Educativos a ni', 3),
(21, 'EPDEB01', 'La Evaluación en el Nivel Básico', 'Analizar los paradisgmas evaluativos en el se', 3),
(22, 'EPDEB01', 'Didáctica de la Ciencia en el Nivel Básico', 'Fomentar las diviersidad de aprendizaje en el', 3),
(23, 'EPDEB01', 'Didáctica de la Matemática para el Nivel Bási', 'Aplicar las ciencias de la matemática coo eje', 3),
(24, 'EPDEB01', 'Didáctica de la Lengua en el Nivel Básico', 'Aplicar el lenguaje para la formación básica ', 3),
(25, 'EPDEB01', 'Practicum I', 'Analizar la metodología de la investigación', 3),
(26, 'EPDEB01', 'Practicum II', 'Aplicación y ejecución de la investigación', 3),
(27, 'EPDEB01', 'Informática para Educadores', 'Capacitar en el área de Informática', 3),
(28, 'EPEI001', 'desarrollo de procesos inciales de edad de 0 ', 'concepcion de edad inicial', 3);
...
INSERT INTO `especialidad` (`cod_especialidad`, `especialidad`, `uc`) VALUES
('EPDEB01', 'Especialista en Procesos Didacticos para la Educacion Basica', 48),
('EPEI001', 'Especialista en Educacion Inicial', 50);
...
INSERT INTO `unidad_tributaria` (`id`, `ut`) VALUES
(1, 177);
...
ALTER TABLE `pagos`
  ...
  ADD UNIQUE KEY `nro_deposito` (`nro_deposito`),
  ADD KEY `idalumno` (`idalumno`),
  ADD KEY `idcurso` (`fecha_registro`),
  ADD KEY `idalumno_2` (`idalumno`),
  ADD KEY `idcurso_2` (`fecha_registro`);
...
ALTER TABLE `rel_alumno_curso`
  ADD KEY `FK_rel_alumno_curso_1` (`idalumno`),
  ADD KEY `FK_rel_alumno_curso_2` (`idcurso`),
  ADD KEY `cod_especialidad` (`cod_especialidad`),
  ADD KEY `idcurso` (`idcurso`),
  ADD KEY `idalumno` (`idalumno`),
  ADD KEY `cohorte` (`cohorte`),
  ADD KEY `cod_especialidad_2` (`cod_especialidad`);
...
--
ALTER TABLE `alumno`
  MODIFY `idalumno` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `curso`
  MODIFY `idcurso` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
